...
class NightActionTarget:
    ...
    ACT_STEAL_ACTIVATED = "Дом гражданина {} будет ограблен."
    ...
    ACT_STAGING_ACTIVATED = "После совершения инсценировки, вы окажетесь в роли {}."
...
class NightResult:
    ...
    ACT_STAGING_SUCCESSFULL = "Инсценировка удалась, ваша новая роль {}."
    ACT_STAGING_UNSUCCESSFUL = "Вам не удалось инсценировать свою смерть, но вы нанесли урон цели."
...
class EffectsResolved:
    ...
    PASS_ALARM = "Система тревоги была активирована."
    ACT_ALARM = "Вы активировали Систему Тревоги, поэтому были вынуждены броситься в бегство."
...
class Errors:
    ...
    SELF_AS_TARGET = "Ошибка! Невозможно выбрать себя в качестве цели."
